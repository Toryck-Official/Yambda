...
export DENSE_ITEM2SID_NPY="${DENSE_ITEM2SID_NPY:-${YAMBA_WORK_DIR}/Regret/artifacts/mappings/raw_rqkmeans/dense_item2sid.npy}"
...
export HPN_CHECKPOINT="${HPN_CHECKPOINT:-${YAMBA_WORK_DIR}/artifacts/models/hpn_warmstart.pt}"
export HPN_META="${HPN_META:-${YAMBA_WORK_DIR}/artifacts/models/hpn_warmstart.meta.json}"
...
# SID actor-critic。
export SID_TRAIN_MODE="${SID_TRAIN_MODE:-offline_transition}"
export TRANSITION_ROOT="${TRANSITION_ROOT:-${YAMBA_WORK_DIR}/Regret/artifacts/transitions/raw_rqkmeans_v2_smoke_timefix}"
export DENSE_ITEM_FEATURES_NPY="${DENSE_ITEM_FEATURES_NPY:-${YAMBA_WORK_DIR}/Regret/artifacts/mappings/raw_rqkmeans/dense_item_features.npy}"
export SID_SAVE_PATH="${SID_SAVE_PATH:-${YAMBA_WORK_DIR}/artifacts/models/yambda_sid}"
export SID_SAVE_META="${SID_SAVE_META:-${YAMBA_WORK_DIR}/artifacts/models/yambda_sid.meta.json}"
...
export SID_MAX_SEQ_LEN="${SID_MAX_SEQ_LEN:-50}"
export SID_MAX_TRAIN_ROWS="${SID_MAX_TRAIN_ROWS:-1000000}"
export SID_MAX_VAL_ROWS="${SID_MAX_VAL_ROWS:-10000}"
export SID_READ_BATCH_SIZE="${SID_READ_BATCH_SIZE:-2048}"
export SID_OFFLINE_EPOCHS="${SID_OFFLINE_EPOCHS:-3}"
export SID_SHUFFLE_TRAIN_FILES="${SID_SHUFFLE_TRAIN_FILES:-1}"
export SID_SHUFFLE_BUFFER_SIZE="${SID_SHUFFLE_BUFFER_SIZE:-0}"
export SID_TRAIN_SAMPLE_ACROSS_FILES="${SID_TRAIN_SAMPLE_ACROSS_FILES:-0}"
export SID_OFFLINE_REWARD_THRESHOLD="${SID_OFFLINE_REWARD_THRESHOLD:-0.0}"
export SID_OFFLINE_REWARD_TEMPERATURE="${SID_OFFLINE_REWARD_TEMPERATURE:-0.5}"
export SID_OFFLINE_BC_WEIGHT="${SID_OFFLINE_BC_WEIGHT:-1.0}"
export SID_OFFLINE_AVOID_WEIGHT="${SID_OFFLINE_AVOID_WEIGHT:-0.25}"
export SID_OFFLINE_CRITIC_WEIGHT="${SID_OFFLINE_CRITIC_WEIGHT:-0.5}"
export SID_OFFLINE_ENTROPY_WEIGHT="${SID_OFFLINE_ENTROPY_WEIGHT:-0.001}"
export SID_OFFLINE_GRAD_CLIP="${SID_OFFLINE_GRAD_CLIP:-5.0}"
